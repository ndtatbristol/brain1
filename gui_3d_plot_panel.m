...
%         set(h_panels.control, 'Units', 'Normalized', 'Position', [0,0,1/2,1/3]);
    ...
    function fn_update_graphs
        ...
        set(h_plot_objects.isosurface, ...
            'Faces', f, ...
            'Vertices', v, ...
            'FaceVertexCData', color_vals ./ max(plot_data.z * options.z_axis_sf) .* length(colormap), ...
            'Visible', 'On');
        
        set(h_plot_objects.isocap, ...
            'Faces', fcap, ...
            'Vertices', vcap, ...
            'FaceVertexCData', ((capcolor_vals+options.db_range) ./ options.db_range) .* length(colormap), ...
            'Visible', 'On');
