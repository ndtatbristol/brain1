function varargout = fn_contact_bscan_wrapper(exp_data, options, mode)
%SUMMARY
...
if data_is_csm
    %next is wrong! not a bscan, but needs only minor mod to this function
    ...
    options_with_precalcs.focal_law = fn_calc_bscan_focal_law2(exp_data, tmp_mesh, calc_focal_law_options);
end
...
info.options_info.aperture_size_metres.default = 0.008;
