function [time_data, LLC] = fn_ag_do_encoded_scan(FLR, direction, scan_steps, time_signals_per_step, varargin)
...
time_signals_per_step = size(time_data,1)/bytes_per_signal;
