function [test_options, system_info] = fn_ag_get_test_options(varargin)
timeout = 10;
if nargin < 1
    echo_on = 0;
else
...
%info as bonus
[raw_result, err_msg] = fn_ag_send_command('STS -1', timeout, echo_on);
%check header byte
...
[raw_result, err_msg] = fn_ag_send_command('XXA 256', timeout, echo_on);
