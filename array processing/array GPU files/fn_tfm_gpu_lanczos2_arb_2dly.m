function result=fn_tfm_gpu_lanczos2_arb_2dly(exp_data,TFM_focal_law,aFactor)
global SYSTEM_TYPES
...
bit_ver=mexext;
ptx_file=['gpu_tfm_lanczos2_arb_2dly_' bit_ver([end-1:end]) '.ptx'];

k = parallel.gpu.CUDAKernel(ptx_file, 'gpu_tfm_lanczos2_arb_2dly.cu');
