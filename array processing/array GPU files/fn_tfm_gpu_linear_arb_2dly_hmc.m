function result=fn_tfm_gpu_linear_arb_2dly_hmc(exp_data,TFM_focal_law)
global SYSTEM_TYPES
...
bit_ver=mexext;
ptx_file=['gpu_tfm_linear_arb_2dly_hmc_' bit_ver([end-1:end]) '.ptx'];

k = parallel.gpu.CUDAKernel(ptx_file, 'gpu_tfm_linear_arb_2dly_hmc.cu');
...
[real_result imag_result]=feval(k,real_result,imag_result,n,combs,real_exp,img_exp,tx, rx, lookup_time_tx, lookup_time_rx,time, pixels, grid_x, grid_y, grid_z, lookup_amp_tx, lookup_amp_rx, tt_weight);
