function result=fn_tfm_gpu_arb_2dly(exp_data,TFM_focal_law)
...
bit_ver=mexext;
ptx_file=['gpu_tfm_arb_2dly_' bit_ver([end-1:end]) '.ptx'];

k = parallel.gpu.CUDAKernel(ptx_file, 'gpu_tfm_arb_2dly.cu');
